...
class MyPymysqlPool():
    ...
    def __init__(self):
        self.db_host = DATABASE_ADDRESS
        self.db_port = int(DATABASE_PORT)
        self.user = DATABASE_USER
        self.password = str(DATABASE_PASSWORD)
...
if __name__ == '__main__':
    ...
    # mysql.insert("insert into fuzzopt.table_name set column_name=%s", (1))
